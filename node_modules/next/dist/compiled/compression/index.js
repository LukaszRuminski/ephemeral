module.exports = function (e, a) {
    ...
    function __webpack_require__(a) {
        ...
        var n = i[a] = {i: a, l: false, exports: {}};
        e[a].call(n.exports, n, n.exports, __webpack_require__);
        n.l = true;
        return n.exports
    }
    ...
    72: function (e, a, i) {
        ...
        Accepts.prototype.type = Accepts.prototype.types = function (e) {
            ...
            var o = this.negotiator.mediaTypes(n.filter(validMime));
            var s = o[0];
            return s ? a[n.indexOf(s)] : false
        };
        ...
        Accepts.prototype.lang = Accepts.prototype.langs = Accepts.prototype.language = Accepts.prototype.languages = function (e) {
            var a = e;
            if (a && !Array.isArray(a)) {
                a = new Array(arguments.length);
                for (var i = 0; i < a.length; i++) {
        ...
        function extToMime(e) {
            return e.indexOf("/") === -1 ? o.lookup(e) : e
        }
        ...
        function lookup(e) {
            ...
            var i = o("x." + e).toLowerCase().substr(1);
            if (!i) {
                return false
            }
        ...
        function populateMaps(e, a) {
            ...
            Object.keys(n).forEach(function forEachMimeType(o) {
                var s = n[o];
                var c = s.extensions;
                if (!c || !c.length) {
                    return
                ...
                for (var t = 0; t < c.length; t++) {
                    ...
                    if (a[p]) {
                        ...
                        if (a[p] !== "application/octet-stream" && (r > l || r === l && a[p].substr(0, 12) === "application/")) {
                            continue
                        }
                    }
                    a[p] = o
        ...
        function parseCharset(e, i) {
            ...
            return {charset: o, q: s, i: i}
        }
        
        function getCharsetPriority(e, a, i) {
            var n = {o: -1, q: 0, s: 0};
            for (var o = 0; o < a.length; o++) {
                var s = specify(e, a[o], i);
                if (s && (n.s - s.s || n.q - s.q || n.o - s.o) < 0) {
                    n = s
                }
            }
            return n
        ...
        function preferredCharsets(e, a) {
            ...
            return n.filter(isQuality).sort(compareSpecs).map(function getCharset(e) {
        ...
        function parseAcceptLanguage(e) {
            var a = e.split(",");
            for (var i = 0, n = 0; i < a.length; i++) {
                var o = parseLanguage(a[i].trim(), i);
                if (o) {
                    a[n++] = o
                }
            }
        ...
        function parseLanguage(e, i) {
            ...
            return {prefix: o, suffix: s, q: t, i: i, full: c}
        }
        ...
        function preferredLanguages(e, a) {
            ...
            return n.filter(isQuality).sort(compareSpecs).map(function getLanguage(e) {
                return a[n.indexOf(e)]
            })
        }
        ...
        var a = /\B(?=(\d{3})+(?!\d))/g;
        var i = /(?:\.0*|(\.[^0]+)0+)$/;
        var n = {b: 1, kb: 1 << 10, mb: 1 << 20, gb: 1 << 30, tb: (1 << 30) * 1024};
        var o = /^((-|\+)?(\d+(?:\.\d+)?)) *(kb|mb|gb|tb)$/i;
        ...
        function format(e, o) {
            ...
            var s = Math.abs(e);
            var c = o && o.thousandsSeparator || "";
            var t = o && o.unitSeparator || "";
            var p = o && o.decimalPlaces !== undefined ? o.decimalPlaces : 2;
            var r = Boolean(o && o.fixedDecimals);
            var l = o && o.unit || "";
            if (!l || !n[l.toLowerCase()]) {
                if (s >= n.tb) {
                    l = "TB"
                } else if (s >= n.gb) {
                    l = "GB"
        ...
        function parseAcceptEncoding(e) {
            ...
            for (var o = 0, s = 0; o < a.length; o++) {
                var c = parseEncoding(a[o].trim(), o);
                if (c) {
                    a[s++] = c;
        ...
        function preferredEncodings(e, a) {
            ...
            return n.filter(isQuality).sort(compareSpecs).map(function getEncoding(e) {
                return a[n.indexOf(e)]
            })
        }
        ...
        e.exports = {
            ...
            "application/ecmascript": {source: "iana", compressible: true, extensions: ["ecma", "es"]},
            ...
            "application/mrb-consumer+xml": {source: "iana", compressible: true, extensions: ["xdf"]},
            "application/mrb-publish+xml": {source: "iana", compressible: true, extensions: ["xdf"]},
            ...
            "application/vnd.syncml+xml": {source: "iana", compressible: true, extensions: ["xsm"]},
            "application/vnd.syncml.dm+wbxml": {source: "iana", extensions: ["bdm"]},
            "application/vnd.syncml.dm+xml": {source: "iana", compressible: true, extensions: ["xdm"]},
            "application/vnd.syncml.dm.notification": {source: "iana"},
            "application/vnd.syncml.dmddf+wbxml": {source: "iana"},
            "application/vnd.syncml.dmddf+xml": {source: "iana", compressible: true, extensions: ["ddf"]},
            ...
            "application/xcap-error+xml": {source: "iana", compressible: true, extensions: ["xer"]},
            ...
            "application/xslt+xml": {source: "iana", compressible: true, extensions: ["xslt"]},
        ...
        function createWriteHead(e, a) {
            ...
            return function writeHead(n) {
                var o = setWriteHeadHeaders.apply(this, arguments);
                if (!i) {
                    i = true;
                    a.call(this);
                    if (typeof o[0] === "number" && this.statusCode !== o[0]) {
                        o[0] = this.statusCode;
                        o.length = 1
                    }
                }
        ...
        function parseAccept(e) {
            ...
            for (var i = 0, n = 0; i < a.length; i++) {
                var o = parseMediaType(a[i].trim(), i);
                if (o) {
                    a[n++] = o
                }
            }
        ...
        function parseMediaType(e, i) {
            ...
            if (n[3]) {
                ...
                for (var r = 0; r < p.length; r++) {
                    ...
                    var m = l[1];
                    var d = m && m[0] === '"' && m[m.length - 1] === '"' ? m.substr(1, m.length - 2) : m;
                    if (u === "q") {
                        s = parseFloat(d);
                        break
                    }
            ...
            return {type: t, subtype: c, params: o, q: s, i: i}
        }
        ...
        function specify(e, a, i) {
            ...
            if (s.length > 0) {
                if (s.every(function (e) {
                    return a.params[e] == "*" || (a.params[e] || "").toLowerCase() == (n.params[e] || "").toLowerCase()
                })) {
                    o |= 1
                } else {
                    return null
        ...
        function preferredMediaTypes(e, a) {
            ...
            return n.filter(isQuality).sort(compareSpecs).map(function getType(e) {
                return a[n.indexOf(e)]
            })
        }
        ...
        function compression(e) {
            ...
            var o = s.parse(a.threshold);
            if (o == null) {
                o = 1024
            }
            return function compression(e, s, c) {
                var u = false;
                var m;
                var d = [];
                var x;
                ...
                var f = s.on;
                var b = s.write;
                s.flush = function flush() {
                    if (x) {
                        x.flush()
                    }
                };
                s.write = function write(e, a) {
                    if (u) {
                        return false
                    }
                    if (!this._header) {
                ...
                s.end = function end(e, a) {
                    ...
                    if (!this._header) {
                        ...
                        console.log('this.2', this._implicitHeader)
                        this._implicitHeader()
                    }
                    if (!x) {
                ...
                p(s, function onResponseHeaders() {
                    if (!i(e, s)) {
                        nocompress("filtered");
                        return
                    }
                    if (!shouldTransform(e, s)) {
                        nocompress("no transform");
                        return
                    }
                    r(s, "Accept-Encoding");
                    if (Number(s.getHeader("Content-Length")) < o || m < o) {
                        nocompress("size below threshold");
                        return
                    }
                    var c = s.getHeader("Content-Encoding") || "identity";
                    if (c !== "identity") {
                    ...
                    s.setHeader("Content-Encoding", u);
                    s.removeHeader("Content-Length");
                    ...
                    f.call(s, "drain", function onResponseDrain() {
                        x.resume()
                    })
                });
                c()
        ...
        function chunkLength(e, a) {
            ...
            return !o.isBuffer(e) ? o.byteLength(e, a) : e.length
        }
        ...
        function toBuffer(e, a) {
            return !o.isBuffer(e) ? o.from(e, a) : e
        }
    }
});